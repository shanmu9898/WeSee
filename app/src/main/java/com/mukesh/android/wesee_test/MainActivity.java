...
class MainActivity implements Camera.PreviewCallback,Camera.AutoFocusCallback, SurfaceHolder.Callback{
     ...
     */
    MainActivity(CameraActivity scanActivity, int currentFrameOrientation) {
